...
sce$clusters_named <- factor(sce$clusters_named,
    levels = c("thBAMs","thMicroglia", "thGran&Mono","thT&NK_cells","thDC&Mono","thAstro1", "thAstro2", "thAstroOligos",  "thOPC1", "thOPC2","thiOligo","thmOligo1", "thmOligo2", "thmOligo3","thEndothelial", "thMural_cells", "thmNeuron", "thMixed"))
