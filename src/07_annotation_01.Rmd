...
<!-- annotation <- read.delim(here("data", "young_FIRE_mice_cluster_anno_02_res.1.tsv")) -->

<!-- celltype <- annotation$Celltype -->
<!-- clusters_named <- annotation$Cluster_name -->

<!-- sce$celltype <- sce$originalexp_snn_res.1  -->
<!-- sce$clusters_named <- sce$originalexp_snn_res.1 -->
