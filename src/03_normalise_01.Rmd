...
plotReducedDim(sce, colour_by= "chip",  dimred = "UMAP") + 
...
```{r}
plotReducedDim(sce, dimred="TSNE", colour_by="chip", point_size=0.1,other_fields = c("Sample")) + facet_wrap(~Sample, nrow = 2)

plotReducedDim(sce, dimred="TSNE", colour_by="sex", point_size=0.1,other_fields = c("Sample")) + facet_wrap(~Sample, nrow = 2)
```
